...
class MongoDriver(
    ...
    init {
        ...
        recordCollection =
            mongoDatabase.getCollection("records", RecordEntity::class.java).withCodecRegistry(codecRegistry)
        passwordCollection =
            mongoDatabase.getCollection("passwords", PasswordEntity::class.java).withCodecRegistry(codecRegistry)
    }
